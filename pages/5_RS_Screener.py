...
DEFAULT_LIST = (
    ...
    "QQQ,IWM,DIA,GLD,TLT"
    "S5FI,RSP,ASPY,QQQIWC,EEM,IWM,HXT,IJR"
    "SLX,URA,GLD,AA,COP.U,XLB,REMX,MP"
    "XLRE,XLU,ITA"
"XSD,BOTZ,SMH,AMZN,MRVL,TSM,NOW,IREN,CRWV"
"PPH,IBB,XBI"
"MLPX,SLV,IGV,GLW,PLTR,LITE,SNDK,WQTM,ARM,VRT,ANET,ASML,NBIS,CIBR,GRID, CHPS.TO, NVDA,TSLA,MU,BE,ICLN,COPX
)
